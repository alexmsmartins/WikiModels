...
class LiftProject(info: ProjectInfo) extends DefaultWebProject(info) {
  ...
  val liftVersion = "2.5"
  val lift = "net.liftweb" % "lift-mapper_2.10" % liftVersion % "compile"
  val liftRecord = "net.liftweb" % "lift-record_2.10" % liftVersion % "compile"
  val liftWidget = "net.liftmodules" % "widgets_2.5_2.10" % "1.3"
  ...
  val slf4jApi = "org.slf4j" % "slf4j-api" % "1.7.5" % "compile"
