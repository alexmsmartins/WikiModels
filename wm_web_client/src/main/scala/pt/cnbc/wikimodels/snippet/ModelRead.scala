    ...
    case Full(user) => {
        ...
        if(restful.getStatusCode == 200){
          ...
          bind("modelInformation", xhtml,
               ...
               "listOfReactions" -> {if(!(modelSBML \\ "model" \ "listOfReactions").isEmpty){
               ...
               "listOfCompartments" -> {if(!(modelSBML \\ "model" \ "listOfCompartments").isEmpty){
              ...
              if((comp \\ "@name").isEmpty){
               ...
               "listOfSpecies" -> {if(!(modelSBML \\ "model" \ "listOfSpecies").isEmpty){
              ...
              if((spec \\ "@name").isEmpty){
               ...
               "listOfParameters" -> {if(!(modelSBML \\ "model" \ "listOfParameters").isEmpty){
              ...
              if((param \\ "@name").isEmpty){
               ...
               "listFunctionsMath" -> {if(!(modelSBML \\ "model" \ "listOfFunctionDefinitions").isEmpty){
              for(val fun <- modelSBML \\ "model" \ "listOfFunctionDefinitions" \\ "functionDefinition";
               ...
               "listReactionsMath" -> { if(!(modelSBML \\ "model" \ "listOfReactions").isEmpty){
              for(val react <- modelSBML \\ "model" \ "listOfReactions" \\ "reaction") yield{
               ...
               "compartmentData" -> { if(!(modelSBML \\ "model" \ "listOfCompartments").isEmpty){
              for(val compartData <- modelSBML \\ "model" \\ "listOfCompartments" \ "compartment") yield {
               ...
               "speciesData" -> { if(!(modelSBML \\ "model" \ "listOfSpecies").isEmpty){
              for(val specData <- modelSBML \\ "model" \ "listOfSpecies" \\ "species";
               ...
               "parametersData" -> { if(!(modelSBML \\ "model" \ "listOfParameters").isEmpty){
              for(val paramData <- modelSBML \\ "model" \ "listOfParameters" \\ "parameter";
               ...
               "extraParametersData" -> { if(!(modelSBML \\ "model" \ "listOfReactions").isEmpty){
