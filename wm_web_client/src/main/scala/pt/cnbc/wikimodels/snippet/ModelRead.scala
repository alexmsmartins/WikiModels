...
class ModelRead {
    ...
    def browseModel (xhtml : NodeSeq) : NodeSeq = User.currentUserName match {
        case Full(user) => {
            ...
            // Search for the <body> and <notes> and replaces for the <div> and <body> tags
            if(model_notes.contains("body")){
                val var2 = model_notes.replaceAll("body", "div")
                v1 = var2.replaceAll("notes", "body")
            } else {
                v1 = model_notes.replaceAll("notes", "body")
            }
        ...
        <a href={'#'+metElems(pos-1).text}>{relElems(pos-1).text}</a></td>
            ...
            bind("modelInformation", xhtml,
                ...
                "listOfReactions" -> {
                 ...
                 "listFunctionsMath" -> {
                    ...
                    <ul><li class="closed"><span><tr id={fun \\ "@metaid"}>
                    {if((fun \\ "@name").isEmpty){
            ...
            {for(val x <- fun\\"notes") yield {
                    ...
                    if(fun_notes.contains("body")){
                        ...
                        v1 = fun_notes.replaceAll("notes", "body")
                    }
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">"""))*/
                 ...
                 "listReactionsMath" -> {
                    ...
                    <ul><li class="closed"><span><tr id={react \\ "@metaid"}>{
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">"""))*/
            ...
            {for(val x <- react\\"notes") yield {
                    ...
                    if(react_notes.contains("body")){
                        ...
                        v1 = react_notes.replaceAll("notes", "body")
                    }
