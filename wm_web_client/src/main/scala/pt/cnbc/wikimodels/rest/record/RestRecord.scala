package pt.cnbc.wikimodels.rest.record
...
trait RestRecord[MyType <: RestRecord[MyType]] extends Record[MyType] {
  ...
  override def saveTheRecord(): Box[MyType] = throw new BackingStoreException("Rest Records don't save themselves. You have to subclass it!")
}
